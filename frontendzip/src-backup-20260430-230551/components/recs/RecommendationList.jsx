...
import { listSignals, getSignal } from '../../lib/signals.js';
import { listPurposes, getPurpose } from '../../lib/purposes.js';
...
export default function RecommendationList({ custId, allowAddToCart = 1 }) {
  ...
  const addToCartMutation = useMutation({
    mutationFn: ({ itemId }) => addToCart(custId, itemId, 1, 'recommendation'),
  ...
  function handleAdd(rec) {
    addToCartMutation.mutate({ itemId: rec.item_id });
  }

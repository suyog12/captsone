...
import { segmentLabel, specialtyLabel } from '../../lib/customerLabels.js';
...
export default function CustomerOverview() {
  ...
  // IMPORTANT: must run before the early return so hook order is stable.
            ...
            <div className="flex items-start justify-between gap-3 flex-wrap">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-1">
                  {segmentLabel(customer.segment)} &middot; {specialtyLabel(customer.specialty_code)} &middot; #{customer.cust_id}
                </p>
              </div>
              <button
                type="button"
